...
### 1.3Propósito, público objetivo y plataformas
...
### 2.1Tipo de modelo de monetización
...
### 2.2Tablas de productos y precios
...
### 3.2Estimación temporal del desarrollo
...
### 4.1Descripción detallada del concepto de juego
...
### 4.2Descripción detallada de las mecánicas de juego


#### 4.2.1Victoria y derrota
...
#### 4.2.4Defensas y enemigos_(Añadir referencias del mismo documento al apartado de Torres y el apartado de Enemigos)_
...
### 5.1Descripción detallada de la historia y la trama
...
### 7.1Diseños básicos de los menús


### 7.2Diagrama de flujo
